...
const ProtectedRoute = ({ children }: { children: ReactNode }) => {
  ...
  if (!hasQuizInvestmentProfile() && location.pathname !== "/ai-learning") {
    return <Navigate to="/ai-learning" replace />;
  }
  return children;
};
