...
const SimulationPage = () => {
  ...
  if (!canUseSimulator) {
    const gateTitle = investmentType ? "투자 시뮬레이터가 잠겨 있습니다" : "투자 성향 진단이 필요합니다";
    const gateDescription = investmentType
      ? "투자 성향별 5단계 학습을 완료해야 가상 투자 기능을 사용할 수 있습니다."
      : "로그인 후 먼저 투자 성향 퀴즈를 완료해야 AI 학습과 투자 시뮬레이터를 사용할 수 있습니다.";
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-[#C7F3EB]/30 px-6 py-12">
        <div className="mx-auto max-w-4xl rounded-2xl border border-gray-200 bg-white p-10 text-center shadow-lg">
          ...
          <h1 className="mb-3 text-3xl font-bold text-[#1D1E20]">{gateTitle}</h1>
          <p className="mb-8 text-[#696969]">{gateDescription}</p>
          <button
            type="button"
    ...
    <div className="min-h-screen bg-white p-8">
      <div className="mx-auto max-w-7xl">
        ...
        <PortfolioTabsPanel
          ...
          onSelectStock={(stock: SimStock) => navigate(`/simulation/${stock.id}`)}
