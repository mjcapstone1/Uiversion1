    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={onRetakeType}
            className="rounded-xl border border-[#42D6BA]/40 bg-[#C7F3EB]/20 px-4 py-2 text-sm font-semibold text-[#3AB8A8] transition-colors hover:bg-[#C7F3EB]/40"
          >
            성향 다시 진단
          </button>
          <button
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-lg">
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#909193]">5단계 학습을 완료하면 투자 시뮬레이터를 사용할 수 있습니다.</p>
          </div>
        ...
        {isAllCompleted && (
          <div className="mb-6 rounded-xl border-2 border-emerald-200 bg-emerald-50 p-5 text-center">
            ...
            <p className="mt-1 text-sm text-emerald-700">이제 가상 투자로 학습 내용을 연습할 수 있습니다.</p>
          </div>
        )}
