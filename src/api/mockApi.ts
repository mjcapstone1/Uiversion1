...
const squads = [
  { squadId: 1, squadName: "서울대학교", region: "서울" },
  { squadId: 2, squadName: "연세대학교", region: "서울" },
  { squadId: 3, squadName: "고려대학교", region: "서울" },
  { squadId: 4, squadName: "성균관대학교", region: "서울" },
  { squadId: 5, squadName: "한양대학교", region: "서울" },
  { squadId: 6, squadName: "이화여자대학교", region: "서울" },
  { squadId: 7, squadName: "중앙대학교", region: "서울" },
  { squadId: 8, squadName: "명지대학교", region: "서울" },
  { squadId: 9, squadName: "경희대학교", region: "서울" },
  { squadId: 10, squadName: "한국외국어대학교", region: "서울" },
  { squadId: 11, squadName: "서울시립대학교", region: "서울" },
  { squadId: 12, squadName: "인하대학교", region: "인천" },
  { squadId: 13, squadName: "아주대학교", region: "경기" },
  { squadId: 14, squadName: "경기대학교", region: "경기" },
  { squadId: 15, squadName: "가톨릭대학교", region: "경기" },
  { squadId: 16, squadName: "한국과학기술원", region: "대전" },
  { squadId: 17, squadName: "충남대학교", region: "대전" },
  { squadId: 18, squadName: "한남대학교", region: "대전" },
  { squadId: 19, squadName: "충북대학교", region: "충북" },
  { squadId: 20, squadName: "부산대학교", region: "부산" },
  { squadId: 21, squadName: "경북대학교", region: "대구" },
  { squadId: 22, squadName: "부경대학교", region: "부산" },
  { squadId: 23, squadName: "경상국립대학교", region: "경남" },
  { squadId: 24, squadName: "전남대학교", region: "광주" },
  { squadId: 25, squadName: "전북대학교", region: "전북" },
  { squadId: 26, squadName: "조선대학교", region: "광주" },
  { squadId: 27, squadName: "강원대학교", region: "강원" },
  { squadId: 28, squadName: "포항공과대학교", region: "경북" },
  { squadId: 29, squadName: "제주대학교", region: "제주" },
];
...
const squadRanking = [
  { squadId: 1, squadName: "서울대학교", currentRanking: 1, totalXp: 18420, weeklyXp: 3250, weeklyXpChangeRate: 12.4, rankingChange: 1 },
  { squadId: 2, squadName: "연세대학교", currentRanking: 2, totalXp: 16900, weeklyXp: 3010, weeklyXpChangeRate: 8.2, rankingChange: -1 },
  { squadId: 3, squadName: "고려대학교", currentRanking: 3, totalXp: 14200, weeklyXp: 2440, weeklyXpChangeRate: 4.6, rankingChange: 0 },
];
...
function handleMock(config: InternalAxiosRequestConfig): AxiosResponse<unknown> {
  ...
  if (path === "/squads") return ok(config, squads);
